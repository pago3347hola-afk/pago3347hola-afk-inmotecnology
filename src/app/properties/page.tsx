      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
        <Card className="overflow-hidden rounded-xl border-0 shadow-none">
          <CardHeader className="p-0">
            ...
            />
            <div className="p-6">
                <CardTitle className="font-headline text-3xl">loft esmeralda</CardTitle>
            </div>
          </CardHeader>
        ...
        <Card className="overflow-hidden rounded-xl border-0 shadow-none">
          <CardHeader className="p-0">
             <Image
              ...
              alt="hacienda santorini"
              width={800}
              height={500}
              className="w-full h-auto object-cover"
            />
            <div className="p-6">
                <CardTitle className="font-headline text-3xl">hacienda santorini</CardTitle>
            </div>
          </CardHeader>
          <CardContent className="p-6 space-y-6">
            <div className="grid grid-cols-2 gap-4 text-sm">
        ...
        <Card className="overflow-hidden rounded-xl border-0 shadow-none">
          <CardHeader className="p-0">
            ...
            />
            <div className="p-6">
                <CardTitle className="font-headline text-3xl">casa monaco</CardTitle>
            </div>
          </CardHeader>
          <CardContent className="p-6 space-y-6">
            <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="investment-info-4" className="border-b-0">
                <AccordionTrigger className="py-3 hover:no-underline">
                  <span className="font-semibold text-base flex items-center gap-2">
                    <Info className="w-5 h-5 text-primary" />
                    Información de Inversión
