          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <Alert>
                ...
                <AlertDescription>
                  El saldo actual es de <span className="font-bold text-foreground">15,230.50 €</span>. Los retiros pueden tardar de 2 a 3 días hábiles en procesarse.
                </AlertDescription>
              </Alert>
              ...
              <div className="space-y-4 border p-4 rounded-md">
                 ...
                 <div className="space-y-2">
                    ...
                    <Input id="beneficiary-name" placeholder="Nombre completo" />
                 </div>
                 <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="bic-swift" placeholder="Ej: BANKESMMXXX" />
                 </div>
              </div>
            </CardContent>
            <CardFooter>
